...
exports.getPRHeadShaForIssueNumber = exports.validateChecks = exports.validateChecksOnPrHead = exports.postComment = exports.log = exports.sleep = exports.dropToReviewLabelAndAddOngoing = exports.dropOngoingLabelAndAddToReview = exports.addToReviewLabel = exports.addOngoingLabel = exports.wereReviewCommentsAdded = void 0;
/**
...
function validateChecks(validateForRef) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        listChecks.data.check_runs.forEach(checkRun => {
            exports.log.info(conclusionsDetails, "current"); // todo del
...
exports.validateChecks = validateChecks;
...
function getPRHeadShaForIssueNumber(pull_number) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        exports.log.info(sha, "sha found");
        return sha;
    });
}
exports.getPRHeadShaForIssueNumber = getPRHeadShaForIssueNumber;
